...
import { getGalleryTitle, getGallerySubtitle, getGalleryLabel } from '../../constants/gallery';
import { AnimatedLine } from '../ui/AnimatedLine';

export function GalleryHero(): React.ReactNode {
  const [isVisible, setIsVisible] = useState(false);
  const sectionRef = useRef<HTMLDivElement>(null);

  const title = getGalleryTitle();
  const subtitle = getGallerySubtitle();
  const sectionLabel = getGalleryLabel();
