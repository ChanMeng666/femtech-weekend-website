    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        ...
        >
          <AnimatedLine
            variant="label"
            label={{ en: 'THE TEAM', zh: '核心团队' }[locale]}
          />
          ...
          <p className="text-muted-foreground text-base max-w-2xl mt-4 leading-relaxed">
            {{ en: 'Founded in September 2024, our team brings together professionals from finance, banking, and consulting, with members across Europe and China.', zh: '成立于2024年9月，我们的团队汇聚了金融、银行和咨询领域的专业人士，成员遍布欧洲和中国。' }[locale]}
          </p>
        </div>
