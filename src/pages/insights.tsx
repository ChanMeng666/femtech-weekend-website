...
import { getInsightsTitle, getInsightsDescription, INSIGHT_CATEGORY_KEYS, getTranslatedCategory } from '../constants/insights';
  ...
  return (
    <>
      <GEOHead
        ...
        keywords={[
          'FemTech market research', 'women health market analysis', 'China FemTech insights',
          'investment analysis', 'market intelligence', 'FemTech trends',
          'Greater China women health', 'Hong Kong FemTech', 'industry insights',
          'women health investment', 'market data', 'research insights'
        ]}
        additionalInstructions="This research hub features investment-grade insights including 'FemTech Market Map 2025: Greater China' and partnership insights with FemmeHealth Ventures Alliance. Focus on Mainland China and Hong Kong markets with global comparative analysis."
        language="en"
      />
      <Layout
        title={title}
        ...
        <GEOTracker
          ...
          additionalMetrics={{
            ...
            featuredInsight: featuredInsight ? 1 : 0,
            categories: Object.keys(INSIGHT_CATEGORY_KEYS).length,
