...
export const partners: PartnerData[] = [
  ...
  { name: 'HeraNova', logo: '/img/summit-partners/heranova.svg', url: 'https://heranova.com/' },
  ...
  { name: 'AVPN', logo: '/img/summit-partners/avpn.svg', url: 'https://avpn.asia/' },
  { name: 'Foreground', logo: '/img/summit-partners/foreground.svg', url: 'https://foreground.vc/' },
  { name: 'Gobi Partners', logo: '/img/summit-partners/gobi.svg', url: 'https://www.gobi.vc/' },
  { name: 'BD', logo: '/img/summit-partners/bd.svg', url: 'https://www.bd.com/en-uk' },
  { name: 'Roche', logo: '/img/summit-partners/roche.svg', url: 'https://www.roche.com/' },
  ...
  { name: 'Tigermed', logo: '/img/summit-partners/tigermedgrp.svg', url: 'https://www.tigermedgrp.com/zh/homepage' },
  { name: 'China Merchants Bank', logo: '/img/summit-partners/cmb.svg', url: 'https://www.cmbchina.com/' },
  { name: 'HSBC', logo: '/img/summit-partners/hsbc.svg', url: 'https://www.hsbc.co.uk/' },
  { name: 'Medtronic', logo: '/img/summit-partners/medtronic.svg', url: 'https://www.medtronic.com/uk-en/index.html' },
  { name: 'Ministry of Foreign Affairs of Denmark', logo: '/img/summit-partners/denmark-mfa.svg', url: 'https://um.dk/en/' },
